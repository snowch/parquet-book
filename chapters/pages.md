...
[To write: the experiment, run on a fixture, that makes the question concrete.]

## Building it

[To write: A page walker for dictionary pages and data pages v1 and v2.]

## What this cannot tell you

[To write: what the experiment and the code leave out.]
...
[To write: problems as stubs in `exercises/src/pages.rs`, graded by `exercises/tests/pages.rs`, and at least one problem about the reader's own files.]
