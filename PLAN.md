...
| 5 | projection, request coalescing, concurrency, prefetching, caching; a query engine | ch10, ch11, ch12 | read path, coalescing and concurrency done; caching and the engine to do |
